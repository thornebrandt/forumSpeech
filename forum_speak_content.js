...
var _FSInterface = __webpack_require__(14);

var _FSInterface2 = _interopRequireDefault(_FSInterface);
...
var ForumSpeak = exports.ForumSpeak = function () {
  ...
  _createClass(ForumSpeak, [{
    ...
    value: function findBody(item) {
      var el = this.displaySpeech ? item : item.cloneNode(true);
      var userTextEl = el.querySelector('.usertext-body');
      var body = '';
      if (userTextEl) {
    ...
    value: function objectifyContent(el, authors) {
      ...
      content.forEach(function (comment, i) {
        var author = _this3.findAuthor(comment);
        var body = _this3.findBody(comment);
        if (author) {
          contentArray.push({
            author: author,
            comment: body,
    ...
    value: function createInterface() {
      ...
      this.fsComponent = _reactDom2.default.render(_react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(
          'div',
          { id: 'handle', style: styles.handle },
          _react2.default.createElement(
            'span',
            { style: styles.title },
            'ForumSpeech'
        ...
        _react2.default.createElement(
          'div',
          { id: 'interface', style: styles.interface },
      ...
      new _Draggable2.default(this.fsEl, { setPosition: false, handle: handle });
    }
  }]);
...
var FSInterface = function (_React$Component) {
  _inherits(FSInterface, _React$Component);
  ...
  function FSInterface(props) {
    ...
    _this.jumpToComment = _this.jumpToComment.bind(_this);
    _this.onChangeJumpComment = _this.onChangeJumpComment.bind(_this);
    _this.startSpeaking = _this.startSpeaking.bind(_this);
    _this.stopSpeaking = _this.stopSpeaking.bind(_this);
    _this.state = {
    ...
    _this.styles = {
      fastForward: {
        backgroundImage: 'url(data:image/png;base64,)',
      ...
      play: {
        backgroundImage: 'url(data:image/png;base64,)',
        backgroundSize: '100% 100%',
        cursor: 'pointer',
        marginRight: '10px',
        width: '2rem',
      ...
      pause: {
        backgroundImage: 'url(data:image/png;base64,)',
        backgroundSize: '100% 100%',
        cursor: 'pointer',
        marginRight: '10px',
        width: '2rem',
  ...
  _createClass(FSInterface, [{
    ...
    key: 'startSpeaking',
    value: function startSpeaking(e) {
      var _this2 = this;

      this.setState(function (prevState) {
        return {
          utterances: _this2.contentToUtterances(_this2.props.contentArray, prevState.utterances)
        };
      }, function () {
        _this2.speakComments(_this2.state.currentComment);
      });
    }
  }, {
    key: 'stopSpeaking',
    ...
    value: function contentToUtterances(contentArray) {
      ...
      if (!utterances.length) {
        contentArray.forEach(function (entry, i) {
          ...
          utterance.rate = _this3.props.rate;
          utterance.onend = _this3.utteranceEndHandler.bind(_this3);
    ...
    value: function incrementComment() {
      ...
      this.setState(function (prevState) {
        return {
          ...
          jumpComment: Number(prevState.currentComment) + 1
        };
      }, function () {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', {
          type: 'text',
          id: 'jumpToComment',
          style: this.styles.jumpToComment
        }),
        _react2.default.createElement(
          'a',
          {
